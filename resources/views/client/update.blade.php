            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        ...
                        <div class="card-body">
                            <div class="body-form ">
                                <form class="form-group" action="/updateCli/traitement" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <input type="number" class="form-control" name="id"
                                        value="{{ $clients->id }}" style="display: none" required>
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Tel_clien
                                        </label>
                                        <input type="number" class="form-control" name="tel_client"
                                            value="{{ $clients->tel_client }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Mot de Passe
                                        </label>
                                        <input type="text" class="form-control" name="password"
                                            value="{{ $clients->password }}" required>
                                    </div>
