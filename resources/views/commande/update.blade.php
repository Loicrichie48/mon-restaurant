            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        ...
                        <div class="card-body">
                            <div class="body-form ">
                                <form class="form-group" action="/updatecommande/traitement" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <input type="number" class="form-control" name="id"
                                        value="{{ $commandes->id }}" style="display: none" required>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Id
                                            Client</label>
                                        <input type="number" class="form-control" name="client"
                                            value="{{ $commandes->client }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Id
                                            Plat</label>
                                        <input type="number" class="form-control" name="plat"
                                            value="{{ $commandes->plat }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Nom
                                        </label>
                                        <input type="text" class="form-control" name="nom"
                                            value="{{ $commandes->nom }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Prenom
                                        </label>
                                        <input type="text" class="form-control" name="prenom"
                                            value="{{ $commandes->prenom }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Email
                                        </label>
                                        <input type="email" class="form-control" name="email"
                                            value="{{ $commandes->email }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Plat commandé
                                        </label>
                                        <input type="text" class="form-control" name="plat_commande"
                                            value="{{ $commandes->plat_commande }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Quantité
                                        </label>
                                        <input type="number" class="form-control" name="quantite"
                                            value="{{ $commandes->quantite }}" required>
                                    </div>
