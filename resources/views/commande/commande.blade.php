                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="form-group" action="/commandes/traitement"
                                                        method="POST" enctype="multipart/form-data">
                                                        @csrf

                                                </div>
                                                <div class="mb-3">
                                                    <label for="exampleInputPassword1" class="form-label">Id Client
                                                    </label>
                                                    <input type="number" class="form-control" name="client"
                                                        required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="exampleInputPassword1" class="form-label">Id Plat
                                                    </label>
                                                ...
                                                <div class="mb-3">
                                                    <label for="exampleInputPassword1" class="form-label">Plat
                                                        commandé
                                                    </label>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($commande as $commande)
                                                <tr>
                                                    ...
                                                    <td>{{ $commande->plat_commande }}</td>
                                                    <td>{{ $commande->quantité }}</td>

                                                    <td>
                                                        <!-- Button trigger modal update -->
                                                        <a href="/updatecommande/{{ $commande->id }}"
                                                        ...
                                                        <a href="/delete-commande/{{ $commande->id }}"
