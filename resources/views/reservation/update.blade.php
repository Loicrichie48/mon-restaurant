            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        ...
                        <div class="card-body">
                            <div class="body-form ">
                                <form class="form-group" action="/updateres/traitement" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <input type="number" class="form-control" name="id"
                                        value="{{ $reservations->id }}" style="display: none" required>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Id
                                            Client</label>
                                        <input type="number" class="form-control" name="Client"
                                            value="{{ $reservations->client }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Date
                                        </label>
                                        <input type="date" class="form-control" name="date"
                                            value="{{ $reservations->date }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Heure
                                        </label>
                                        <input type="time" class="form-control" name="heure"
                                            value="{{ $reservations->heure }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Nombre de Personne
                                        </label>
                                        <input type="number" class="form-control" name="nombre_personne"
                                            value="{{ $reservations->nombre_personne }}" required>
                                    </div>
