            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        ...
                        <div class="card-body">
                            <div class="body-form ">
                                <form class="form-group" action="/updatetable/traitement" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <input type="number" class="form-control" name="id"
                                        value="{{ $tables->id }}" style="display: none" required>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Id
                                            Reservation</label>
                                        <input type="number" class="form-control" name="reservation"
                                            value="{{ $tables->reservation }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Numero Table
                                        </label>
                                        <input type="number" class="form-control" name="numero_table"
                                            value="{{ $tables->numero_table }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Nombre Place
                                        </label>
                                        <input type="number" class="form-control" name="nombre_place"
                                            value="{{ $tables->heure }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Statut
                                        </label>
                                        <input type="text" class="form-control" name="statut"
                                            value="{{ $tables->statut }}" required>
                                    </div>
