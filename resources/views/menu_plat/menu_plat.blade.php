                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="form-group" action="/menu_plats/traitement"
                                                ...
                                                <div class="mb-3">
                                                    <label for="exampleInputPassword1" class="form-label">Nombre personne
                                                    </label>
                                            ...
                                            @foreach ($reservations as $reservation)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="/updatereservation/{{ $reservation->id }}"
                                                        ...
                                                        <a href="/delete-reservation/{{ $reservation->id }}"
